...
rootPath='/media/leohoinaski/HDD/HospitalDisaggregation'

outPath='/media/leohoinaski/HDD/HospitalDisaggregation/Outputs'

#popfile = 'bra_ppp_2019_1km_Aggregated.tif'

hospFile = 'result_resp_2020_final.csv' # Hospitalization file
...
fileId = 'SC_respiratory' # Code to identify your output files
...
hosp = pd.read_csv(rootPath+'/Inputs/'+hospFile)
...
if runOrNotTemporal==1:
    name = 'HOSP_daily_'+fileId+'_'+str(deltaX)+'x'+str(deltaY)+'_'+str(hosp.ANO_CMPT[0])+'.nc'
